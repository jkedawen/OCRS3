...
class TransmutationLecLab4060Service
{
      
     public static function getTransmutationTableLEC()
    {
        return [
    ...
    public static  function getLab4060TransmutationTable($totalMaxPointsLab)
    {
        //// Calculate LPS
    ...
    public static  function getLab4060TransmutationTableMidterms($totalMaxPointsLabMidterms)
    {
        //// Calculate LPS
     ...
     public static  function getLab4060TransmutationTableFinals($totalMaxPointsLabFinals)
    {
        //// Calculate LPS
