...
class TransmutationLecLab5050Service
{

    public static  function getLab5050TransmutationTable($totalMaxPointsLab)
    {
        //// Calculate LPS
    ...
    public static  function getLab5050TransmutationTableMidterms($totalMaxPointsLabMidterms)
    {
        //// Calculate LPS
     ...
     public static  function getLab5050TransmutationTableFinals($totalMaxPointsLabFinals)
    {
        //// Calculate LPS
